...
ENV_VARS: Dict[int, Dict[str, object]] = {
    ...
    55: {"name": "CAI_TRACING", "description": "Enable OpenTelemetry tracing", "default": "false"},
    56: {"name": "CAI_TELEMETRY", "description": "Enable telemetry collection", "default": "false"},
    57: {"name": "CAI_DISABLE_SESSION_RECORDING", "description": "Disable JSONL recording", "default": "true"},
    58: {"name": "CAI_DISABLE_USAGE_TRACKING", "description": "Disable usage tracking", "default": "true"},
